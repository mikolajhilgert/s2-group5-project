        ...
        private void btnAddEmployee_Click(object sender, EventArgs e)
        {
            ...
            if ((!String.IsNullOrEmpty(tbFirstName.Text)) && (!String.IsNullOrEmpty(tbLastName.Text)) && ((dtpEmployee.Value!=null)) && (!String.IsNullOrEmpty(tbBSN.Text)) && (!String.IsNullOrEmpty(tbPosition.Text)) && (!String.IsNullOrEmpty(cbWorkingH.Text)) && (!String.IsNullOrEmpty(tbPhone.Text)) && (!String.IsNullOrEmpty(tbAddress.Text)) && (!String.IsNullOrEmpty(tbEmail.Text)) && (!String.IsNullOrEmpty(tbEmergencyN.Text)) && (!String.IsNullOrEmpty(tbContactR.Text)) && (!String.IsNullOrEmpty(tbEmergencyNr.Text)) && (!String.IsNullOrEmpty(tbCertifications.Text)) && (!String.IsNullOrEmpty(tbLanguage.Text)) && (!String.IsNullOrEmpty(dateTimeStart.Text)) && (!String.IsNullOrEmpty(dateTimeEnd.Text)) && (!String.IsNullOrEmpty(tbPassword.Text)))
                if((DateTime.Parse(dateTimeStart.Text) < DateTime.Parse(dateTimeEnd.Text))&& BSNmatch.Success && int.TryParse(tbSalary.Text, out int value))
                {
                    ...
                    employeeManagement.AddEmployee(tbFirstName.Text, tbLastName.Text, dtpEmployee.Value, tbBSN.Text, tbPosition.Text, Convert.ToInt32(cbWorkingH.Text), tbPhone.Text, tbAddress.Text, tbEmail.Text, tbPassword.Text, tbEmergencyN.Text, tbContactR.Text, tbEmergencyNr.Text, tbCertifications.Text, tbLanguage.Text, dateTimeStart.Value, dateTimeEnd.Value, Convert.ToInt32(tbSalary.Text));
                    tbAddress.Text = tbBSN.Text = tbCertifications.Text = tbContactR.Text = tbEmail.Text = tbPassword.Text = tbEmergencyN.Text = tbEmergencyNr.Text = tbFirstName.Text = tbLanguage.Text = tbLastName.Text = tbPhone.Text = tbPhoneNumber.Text = tbPosition.Text = tbSalary.Text = string.Empty;
